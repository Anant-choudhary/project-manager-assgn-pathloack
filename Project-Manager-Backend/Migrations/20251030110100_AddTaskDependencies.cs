    ...
    public partial class AddTaskDependencies : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDependency", x => new { x.DependencyId, x.ProjectTaskId });
                    table.ForeignKey(
                        name: "FK_TaskDependency_Tasks_DependencyId",
                        column: x => x.DependencyId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskDependency_Tasks_ProjectTaskId",
